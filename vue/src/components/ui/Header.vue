...
<template>
    <!-- ========== HEADER ========== -->
    <header
        class="flex flex-row z-50 w-full text-sm max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 justify-between items-center">
        <!-- Logo -->
        <div>
        ...
        <div class="hs-dropdown relative inline-flex">
            <button id="hs-dropdown-custom-trigger" type="button"
                ...
                <div v-else>
                    <img @click="logout" class="inline-block size-[55px] rounded-full border-2 border-blue-600 mt-4"
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700"
                ...
                <div class="p-1 space-y-0.5">
                    <RouterLink class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                        :to="{ name: 'settings' }">
