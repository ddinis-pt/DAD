...
<template>
  <div class="flex items-center w-full justify-center bg-gray-800 min-h-screen min-w-screen">
    <main class="w-full max-w-md px-6 py-4 bg-white rounded-xl shadow-md bg-gray-800">
      <div class="flex flex-col space-y-2">
        ...
        <div class="text-center py-4">
          <h2 class="block text-2xl font-bold text-gray-800 text-white">Log into your account</h2>
        </div>
        ...
        <div class="mt-5">
          ...
          <form>
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="password" type="password" id="password" name="password"
                    placeholder="&#9679; &#9679; &#9679; &#9679; &#9679; &#9679; &#9679; &#9679; &#9679; "
                    class="py-3 px-4 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-neutral-900 border-neutral-700 text-neutral-400 placeholder-neutral-500 focus:ring-neutral-600"
              ...
              <div class="flex items-center">
                <div class="flex">
                  <input id="remember-me" name="remember-me" type="checkbox" checked
                    class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 bg-neutral-800 border-neutral-700 checked:bg-blue-500 checked:border-blue-500 focus:ring-offset-gray-800">
                </div>
                <div class="ms-3">
              ...
              <div class="flex items-center text-xs text-black uppercase text-neutral-500 py-3">
                <div class="flex-1 border-t border-black border-neutral-600"></div>
      ...
      <div class="text-center pt-4">
        <RouterLink :to="{ name: 'about' }"
          class="text-sm text-blue-600 hover:underline focus:outline-none focus:underline font-medium text-blue-500">
          About
        </RouterLink>
      </div>
    </main>
